    ...
    return (React.createElement("section", { className: "py-24 px-6 md:px-12 max-w-[1400px] mx-auto hide-out" },
        React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" },
            React.createElement("div", null,
                ...
                ].map(function (item) { return (React.createElement("div", { key: item, className: "flex items-center gap-3" },
...
function Onboarding() {
    return (React.createElement("section", { className: "py-24 px-6 md:px-12 max-w-[1400px] mx-auto" },
        React.createElement("div", { className: "mb-16" },
            React.createElement("p", { className: "font-mono text-xs text-primary tracking-[0.2em] uppercase mb-4" },
                " ",
                "\u2014 Backstage Pass"),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch("/.netlify/functions/contact", {
                                method: "POST",
                    ...
                    case 5:
                        err_1 = _a.sent();
                        console.error(err_1);
                        setError(err_1.message || "An error occurred");
                        return [3 /*break*/, 7];
                    case 6:
                        setLoading(false);
                        return [7 /*endfinally*/];
        ...
        React.createElement("div", { className: "px-6 md:px-12 max-w-[1400px] mx-auto" },
            React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-16 items-start" },
                ...
                React.createElement("div", null, sent ? (React.createElement("div", { className: "border border-primary/30 bg-primary/5 p-12 text-center" },
                    ...
                    React.createElement("p", { className: "text-muted-foreground text-sm" }, "Our team will be in touch within 24 hours to schedule your alignment call."))) : (React.createElement("form", { onSubmit: handleSubmit, className: "space-y-5" },
                    [
                        {
                            name: "name",
                            label: "Your name",
                    ...
                    React.createElement("div", null,
                        ...
                        React.createElement("textarea", { required: true, rows: 5, value: form.message, onChange: function (e) {
                                return setForm(__assign(__assign({}, form), { message: e.target.value }));
                            }, className: "w-full bg-background border border-border text-foreground px-4 py-3 text-sm focus:outline-none focus:border-primary/60 transition-colors resize-none placeholder:text-muted-foreground/40", placeholder: "What are you working on? What is the scale of your content needs?" })),
                    error && (React.createElement("div", { className: "text-sm text-destructive" }, error)),
                    React.createElement("button", { type: "submit", disabled: loading, className: "w-full bg-primary text-primary-foreground py-4 font-bold text-sm tracking-wide hover:bg-primary/85 transition-colors flex items-center justify-center gap-2" },
