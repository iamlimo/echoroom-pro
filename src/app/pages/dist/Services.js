                ...
                React.createElement("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" },
                    React.createElement("div", null,
                        ...
                        React.createElement("h2", { className: "font-display text-4xl md:text-6xl font-black text-primary-foreground leading-tight mb-4" },
                            ...
                            React.createElement("br", null),
                            "multiple vendors."),
                        React.createElement("p", { className: "text-primary-foreground/70 text-lg leading-relaxed" }, "All 6 service pillars under one roof. One account manager, one invoice, zero micro-management. Your marketing team gets back to strategy \u2014 we handle everything else.")),
