...
exports.ALL_SHOWS = exports.SHOW_CATEGORY_DATA = exports.CONTENT_KINDS = void 0;
exports.CONTENT_KINDS = ["Live sessions", "Specials", "Behind the scenes", "Podcast", "Stories", "Interviews"];

var b2 = function b2(path) {
...
exports.SHOW_CATEGORY_DATA = {
  ...
  Podcast: [{
    id: "podcast-synths",
    category: "Podcast",
    title: "The Link up Podcast- Rhennie Sister",
...
exports.ALL_SHOWS = exports.CONTENT_KINDS.flatMap(function (category) {
  return exports.SHOW_CATEGORY_DATA[category];
});